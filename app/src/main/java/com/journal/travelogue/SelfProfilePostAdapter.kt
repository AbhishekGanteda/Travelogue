...
import com.journal.travelogue.ProfilePostAdapter.ProfilePostViewHolder
...
class SelfProfilePostAdapter(private val postList: MutableList<ProfilePostItem>):
    RecyclerView.Adapter<SelfProfilePostAdapter.SelfProfilePostViewHolder>(){

    private var user: User? = null
    private lateinit var sharedPreferences: android.content.SharedPreferences
    val ip = RetrofitClient.ip

    class SelfProfilePostViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SelfProfilePostViewHolder {
        ...
        loadUserData()
        return SelfProfilePostViewHolder(view)
    }

    override fun onBindViewHolder(holder: SelfProfilePostViewHolder, position: Int) {
